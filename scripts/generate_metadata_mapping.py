...
morphology_src_file_name = "../content/metadata/quranic-corpus-morphology-0.4.txt"
...
def get_surah_metadata(ayah_number_ayah_index_mapping):

    surah_metadata_details = collections.OrderedDict()
    for i in range(1, 115):
        surah_metadata_details[str(i)] = {
    ...
    for i in range(1, len(ruku_list)):
        ...
        surah_metadata_details[surah_number_str]["ruku"].append(get_ruku_metadata(ruku_list[i], i, len(surah_metadata_details[surah_number_str]["ruku"]), ayah_number_ayah_index_mapping))


    return surah_metadata_details

def get_ruku_metadata(ruku, ruku_index, num_of_previous_ruku, ayah_number_ayah_index_mapping):
    surah_number = ruku[0]
    ayah_number = ruku[1]
    key = str(surah_number) + ":" + str(ayah_number)
    index = ayah_number_ayah_index_mapping.index(key)
    ...
    if (surah_number == 114):
        ...
        next_index = ayah_number_ayah_index_mapping.index(next_key)


        for i in range(index, next_index):
            aayaah_in_ruku.append(ayah_number_ayah_index_mapping[i])
...
def get_full_ruku_metadata(surah_metadata):
    ...
    return ruku_metadata

def display_ruku_index(surah_metadata):
...
def get_parsed_content_info():
    with open(morphology_src_file_name, 'r') as file_pointer:
        content_details = collections.OrderedDict()
        ayah_root_sequence = collections.OrderedDict()
        root_statistics = collections.OrderedDict()
        line = file_pointer.readline()
        ayah_number_ayah_index_mapping = []
        ayah_number_ayah_index_mapping.append("start")
        count = 0
        root_ayah_index_mapping_table = []
        ...
        while line:
            ...
            if line[0] == "(":
                ...
                if ayah_index not in content_details:
                    content_details[ayah_index] = {
                        "ayah_index": "",
                        "content": list()
                    }

                content_details[ayah_index]["ayah_index"] = ayah_index;
                content_details[ayah_index]["content"].append({
                ...
                if bw_root_text is not None:
                    ...
                    root_ayah_index_mapping_table.append([bw_root_text, ayah_index])
        ...
        for key, value in content_details.iteritems():
            ayah_number_ayah_index_mapping.append(key);

    return [ayah_root_sequence, root_statistics, ayah_number_ayah_index_mapping, root_ayah_index_mapping_table, content_details]


def get_juz_mapping(content_details):
    juz_ayah_index = []

    for i in range(1, 31):
        juz_ayah_index.append("%d:%d" % (juz[i][0], juz[i][1]))

    result = []
    mark = None

    for ayah_index in content_details:
        if ayah_index in juz_ayah_index:
            mark = (juz_ayah_index.index(ayah_index) + 1)

        result.append([ayah_index, mark])
...
#  |____|    (____  /__|  /____  >\___  >____ |   \______  /\____/|___|  /__|  \___  >___|  /__|
#                 \/           \/     \/     \/          \/            \/          \/     \/
parsed_content_info = get_parsed_content_info()

ayah_root_sequence = parsed_content_info[0]
...
# __________               __    ___________         _____                .__      .___            .___                 _____                       .__                 ___________     ___.   .__
# \______   \ ____   _____/  |_  \__    ___/___     /  _  \ ___.__._____  |  |__   |   | ____    __| _/____ ___  ___   /     \ _____  ______ ______ |__| ____    ____   \__    ___/____ \_ |__ |  |   ____
#  |       _//  _ \ /  _ \   __\   |    | /  _ \   /  /_\  <   |  |\__  \ |  |  \  |   |/    \  / __ |/ __ \\  \/  /  /  \ /  \\__  \ \____ \\____ \|  |/    \  / ___\    |    |  \__  \ | __ \|  | _/ __ \
#  |    |   (  <_> |  <_> )  |     |    |(  <_> ) /    |    \___  | / __ \|   Y  \ |   |   |  \/ /_/ \  ___/ >    <  /    Y    \/ __ \|  |_> >  |_> >  |   |  \/ /_/  >   |    |   / __ \| \_\ \  |_\  ___/
...
root_ayah_index_mapping_table_file_name = "root_ayah_index_mapping_table.sql"
root_ayah_index_mapping_table = parsed_content_info[3]
root_ayah_index_buffer = []

for i in range(len(root_ayah_index_mapping_table)):
...
root_statistics_mapping_table_file_name = "root_statistics.sql"
root_statistics_buffer = []

for root in root_statistics:
...
#  /   _____/__ ______________  |  |__     /     \   _____/  |______     __| _/____ _/  |______
#  \_____  \|  |  \_  __ \__  \ |  |  \   /  \ /  \_/ __ \   __\__  \   / __ |\__  \\   __\__  \
#  /        \  |  /|  | \// __ \|   Y  \ /    Y    \  ___/|  |  / __ \_/ /_/ | / __ \|  |  / __ \_
# /_______  /____/ |__|  (____  /___|  / \____|__  /\___  >__| (____  /\____ |(____  /__| (____  /
#         \/                  \/     \/          \/     \/          \/      \/     \/          \/
surah_metadata = get_surah_metadata(ayah_number_ayah_index_mapping)
surah_metadata_file_name = "surah_metadata.json"
write_to_file(surah_metadata_file_name, json.dumps(surah_metadata, indent=4, ensure_ascii=False).encode('utf8'))


# __________       __           .___            .___
# \______   \__ __|  | ____ __  |   | ____    __| _/____ ___  ___
#  |       _/  |  \  |/ /  |  \ |   |/    \  / __ |/ __ \\  \/  /
#  |    |   \  |  /    <|  |  / |   |   |  \/ /_/ \  ___/ >    <
#  |____|_  /____/|__|_ \____/  |___|___|  /\____ |\___  >__/\_ \
#         \/           \/                \/      \/    \/      \/
ruku_index = display_ruku_index(surah_metadata)
ruku_to_surah_map_file_name = "ruku_to_surah_map.json"
write_to_file(ruku_to_surah_map_file_name, json.dumps(ruku_index, indent=4, ensure_ascii=False).encode('utf8'))


# __________       __              _____          __              .___       __
# \______   \__ __|  | ____ __    /     \   _____/  |______     __| _/____ _/  |______
#  |       _/  |  \  |/ /  |  \  /  \ /  \_/ __ \   __\__  \   / __ |\__  \\   __\__  \
#  |    |   \  |  /    <|  |  / /    Y    \  ___/|  |  / __ \_/ /_/ | / __ \|  |  / __ \_
#  |____|_  /____/|__|_ \____/  \____|__  /\___  >__| (____  /\____ |(____  /__| (____  /
#         \/           \/               \/     \/          \/      \/     \/          \/
full_ruku_metadata = get_full_ruku_metadata(surah_metadata)
ruku_metadata_file_name = "ruku_metadata.json"
write_to_file(ruku_metadata_file_name, json.dumps(full_ruku_metadata, indent=4))


#    _____                .__      .___            .___              ___________           ____.                 _____                       .__
#   /  _  \ ___.__._____  |  |__   |   | ____    __| _/____ ___  ___ \__    ___/___       |    |__ __________   /     \ _____  ______ ______ |__| ____    ____
#  /  /_\  <   |  |\__  \ |  |  \  |   |/    \  / __ |/ __ \\  \/  /   |    | /  _ \      |    |  |  \___   /  /  \ /  \\__  \ \____ \\____ \|  |/    \  / ___\
# /    |    \___  | / __ \|   Y  \ |   |   |  \/ /_/ \  ___/ >    <    |    |(  <_> ) /\__|    |  |  //    /  /    Y    \/ __ \|  |_> >  |_> >  |   |  \/ /_/  >
# \____|__  / ____|(____  /___|  / |___|___|  /\____ |\___  >__/\_ \   |____| \____/  \________|____//_____ \ \____|__  (____  /   __/|   __/|__|___|  /\___  /
#         \/\/          \/     \/           \/      \/    \/      \/                                       \/         \/     \/|__|   |__|           \//_____/
