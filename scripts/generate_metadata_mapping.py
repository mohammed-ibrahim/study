...
file_name = "../content/metadata/quranic-corpus-morphology-0.4.txt"
...
def populateMetaMapping():
    ...
    writeToFile(surah_metadata_file_name, json.dumps(surah, indent=4, ensure_ascii=False).encode('utf8'))
...
def displayRukuMetadata():
    ...
    writeToFile(ruku_metadata_file_name, json.dumps(ruku_metadata, indent=4))
...
def displayRukuIndex():
    ...
    writeToFile(ruku_to_surah_map_file_name, json.dumps(ruku_map, indent=4))
...
def populateArabicContent():
    ...
    writeToFile(ayah_root_sequence_file_name, json.dumps(ayah_root_sequence, indent=4))
    writeToFile(root_statistics_file_name, json.dumps(root_statistics, indent=4))
